	...
	return (
		<div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
			...
			<div style={{ marginBottom: '20px', padding: '15px', backgroundColor: '#e3f2fd', borderRadius: '4px', border: '1px solid #2196f3' }}>
				...
				<p style={{ margin: '0 0 10px 0', fontSize: '14px' }}>Current delays (updates automatically when changed in MockUI):</p>
			...
			<div style={{ marginTop: '20px', padding: '15px', backgroundColor: '#f5f5f5', borderRadius: '4px' }}>
				...
				<ul>
					...
					<li>
						<strong>Platform State:</strong> The blue box above shows current delays from <code>platform.getEffectiveDelay()</code>
					</li>
					<li>
						<strong>Real-time Updates:</strong> Change delays in MockUI and watch the buttons and display update automatically
					</li>
				</ul>
			</div>
		</div>
