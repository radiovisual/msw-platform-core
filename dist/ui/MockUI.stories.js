...
function DemoApp() {
	...
	return (0, jsx_runtime_1.jsxs)('div', {
		style: { padding: 32 },
		children: [
			(0, jsx_runtime_1.jsx)('h2', { className: 'text-xl font-bold mb-4', children: 'Demo: /api/hello & /api/goodbye' }),
			(0, jsx_runtime_1.jsx)('button', { className: 'border rounded px-4 py-2 mb-4', onClick: fetchHello, children: 'Fetch /api/hello' }),
			(0, jsx_runtime_1.jsx)('button', {
				className: 'border rounded px-4 py-2 mb-4',
				onClick: fetchGoodbye,
				style: { marginLeft: 8 },
				children: 'Fetch /api/goodbye',
			}),
			(0, jsx_runtime_1.jsx)('button', {
				className: 'border rounded px-4 py-2 mb-4',
				onClick: fetchUser,
			...
			(0, jsx_runtime_1.jsx)('button', {
				className: 'border rounded px-4 py-2 mb-4',
				onClick: fetchUserAdmin,
				style: { marginLeft: 8 },
				children: 'Fetch /api/user?type=admin',
			}),
			(0, jsx_runtime_1.jsx)('button', {
				className: 'border rounded px-4 py-2 mb-4',
				onClick: fetchUserGuest,
				style: { marginLeft: 8 },
				children: 'Fetch /api/user?type=guest',
			}),
			(0, jsx_runtime_1.jsx)('button', {
				className: 'border rounded px-4 py-2 mb-4',
				onClick: fetchUserStatus,
				style: { marginLeft: 8 },
				children: 'Fetch /api/user-status',
			}),
			(0, jsx_runtime_1.jsx)('button', {
				className: 'border rounded px-4 py-2 mb-4',
				onClick: fetchExternalUser,
				style: { marginLeft: 8 },
				children: 'Fetch https://jsonplaceholder.typicode.com/users/1',
			}),
			(0, jsx_runtime_1.jsx)('pre', {
				className: 'bg-gray-100 p-2 rounded',
				children: result ? JSON.stringify(result, null, 2) : error ? error : 'No data yet',
			}),
			(0, jsx_runtime_1.jsx)(MockUI_1.default, { platform: platform }),
		],
	});
}
const meta = {
