...
const Popover = ({ trigger, children, open: controlledOpen, onOpenChange, placement = 'left' }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("span", { style: { position: "relative", display: "inline-block" }, children: [(0, jsx_runtime_1.jsx)("span", { onClick: () => setOpen(!open), style: { cursor: "pointer" }, children: trigger }), open && ((0, jsx_runtime_1.jsx)("div", { ref: popoverRef, style: {
                    position: "absolute",
                    top: "100%",
