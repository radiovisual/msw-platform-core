...
function makePlatform(overrides = []) {
	...
	return (0, platform_1.createMockPlatform)(
		{ name: 'test', plugins, featureFlags: ['FLAG_A', 'FLAG_B'] },
		new platform_1.InMemoryPersistence('test')
	);
}
describe('MockUI', () => {
	beforeEach(() => {
	...
	it('renders endpoints and feature flags from platform', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			...
			expect(
				yield react_1.screen.findByText((c, n) => (n === null || n === void 0 ? void 0 : n.textContent) === '/api/v1/foo' || false)
			).toBeInTheDocument();
			expect(
				yield react_1.screen.findByText((c, n) => (n === null || n === void 0 ? void 0 : n.textContent) === '/api/v1/bar' || false)
			).toBeInTheDocument();
			...
			expect(
				yield react_1.screen.findByText((c, n) => (n === null || n === void 0 ? void 0 : n.textContent) === 'FLAG_A' || false)
			).toBeInTheDocument();
			expect(
				yield react_1.screen.findByText((c, n) => (n === null || n === void 0 ? void 0 : n.textContent) === 'FLAG_B' || false)
			).toBeInTheDocument();
		}));
	it('toggles endpoint passthrough and updates disabledPluginIds', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			const platform = makePlatform();
			(0, react_1.render)((0, jsx_runtime_1.jsx)(MockUI_1.default, { platform: platform }));
			react_1.fireEvent.click(yield react_1.screen.findByTestId('open-settings'));
	...
	it('changes status code and updates platform', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			const platform = makePlatform();
			(0, react_1.render)((0, jsx_runtime_1.jsx)(MockUI_1.default, { platform: platform }));
			react_1.fireEvent.click(yield react_1.screen.findByTestId('open-settings'));
	...
	it('toggles feature flag and updates platform', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			const platform = makePlatform();
			(0, react_1.render)((0, jsx_runtime_1.jsx)(MockUI_1.default, { platform: platform }));
			react_1.fireEvent.click(yield react_1.screen.findByTestId('open-settings'));
	...
	it('creates, renames, deletes groups and manages membership', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			const platform = makePlatform();
			(0, react_1.render)((0, jsx_runtime_1.jsx)(MockUI_1.default, { platform: platform }));
			react_1.fireEvent.click(yield react_1.screen.findByTestId('open-settings'));
			...
			const input = yield react_1.screen.findByPlaceholderText((c, n) => {
				var _a;
				return (
					((_a = n === null || n === void 0 ? void 0 : n.getAttribute('placeholder')) === null || _a === void 0
						? void 0
						: _a.toLowerCase()) === 'new group name'
				);
			});
			react_1.fireEvent.change(input, { target: { value: 'TestGroup' } });
			react_1.fireEvent.keyDown(input, { key: 'Enter' });
			expect(
				yield react_1.screen.findByText((c, n) => (n === null || n === void 0 ? void 0 : n.textContent) === 'TestGroup' || false)
			).toBeInTheDocument();
			// Rename group
			...
			expect(
				yield react_1.screen.findByText((c, n) => (n === null || n === void 0 ? void 0 : n.textContent) === 'RenamedGroup' || false)
			).toBeInTheDocument();
			// Delete group
			const trashButtons = yield react_1.screen.findAllByRole('button', { name: /trash/i });
			react_1.fireEvent.click(trashButtons[0]);
			yield (0,
			react_1.waitFor)(() => expect(react_1.screen.queryByText((c, n) => (n === null || n === void 0 ? void 0 : n.textContent) === 'RenamedGroup' || false)).not.toBeInTheDocument());
		}));
	it('persists groups and disabledPluginIds to localStorage', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			...
			react_1.fireEvent.keyDown(input, { key: 'Enter' });
			expect(
				yield react_1.screen.findByText((c, n) => (n === null || n === void 0 ? void 0 : n.textContent) === 'PersistedGroup' || false)
			).toBeInTheDocument();
	...
	it('minimal stateless: renders a plain checkbox with aria-label after remount', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			const { unmount } = (0, react_1.render)(
				(0, jsx_runtime_1.jsx)('input', { type: 'checkbox', 'aria-label': 'Toggle endpoint /api/v1/foo' })
			);
	...
	it('namespaces localStorage by platform name', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			localStorage.clear();
			const platformA = (0, platform_1.createMockPlatform)(
				{
					name: 'appA',
					plugins: [
				...
				new platform_1.InMemoryPersistence('appA')
			);
			const platformB = (0, platform_1.createMockPlatform)(
				{
					name: 'appB',
					plugins: [
				...
				new platform_1.InMemoryPersistence('appB')
			);
			...
			const inputA = yield react_1.screen.findByPlaceholderText((c, n) => {
				var _a;
				return (
					((_a = n === null || n === void 0 ? void 0 : n.getAttribute('placeholder')) === null || _a === void 0
						? void 0
			...
			expect(
				yield react_1.screen.findByText((c, n) => (n === null || n === void 0 ? void 0 : n.textContent) === 'GroupA' || false)
			).toBeInTheDocument();
			...
			react_1.fireEvent.click(yield react_1.screen.findByTestId('open-settings'));
			react_1.fireEvent.click(yield react_1.screen.findByRole('tab', { name: /groups/i }));
			const inputB = yield react_1.screen.findByPlaceholderText((c, n) => {
				var _a;
				return (
					((_a = n === null || n === void 0 ? void 0 : n.getAttribute('placeholder')) === null || _a === void 0
						? void 0
			...
			expect(
				yield react_1.screen.findByText((c, n) => (n === null || n === void 0 ? void 0 : n.textContent) === 'GroupB' || false)
			).toBeInTheDocument();
			...
			expect(
				react_1.screen.queryByText((c, n) => (n === null || n === void 0 ? void 0 : n.textContent) === 'GroupB' || false)
			...
			expect(
				react_1.screen.queryByText((c, n) => (n === null || n === void 0 ? void 0 : n.textContent) === 'GroupA' || false)
			).not.toBeInTheDocument();
		}));
	it('renders automatic groups for componentId and prevents deletion', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			const platform = makePlatform();
			(0, react_1.render)((0, jsx_runtime_1.jsx)(MockUI_1.default, { platform: platform }));
			react_1.fireEvent.click(yield react_1.screen.findByTestId('open-settings'));
	...
	it('shows scenario dropdown, persists selection, and updates response', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			const plugins = [
				{
					id: 'ep1',
					...
					scenarios: [
						{ id: 'not-registered', label: 'User not registered', responses: { 200: { error: 'User not registered' } } },
						{
							...
							responses: { 200: { ok: 'User is registered' }, 400: { error: 'custom bad' } },
						},
					],
				},
			];
			...
			yield (0,
			react_1.waitFor)(() => expect(platformAfterNotRegistered.getResponse('ep1', 200)).toEqual({ error: 'User not registered' }));
	...
	it('minimal: renders a plain checkbox, unmounts, and remounts', () =>
		__awaiter(void 0, void 0, void 0, function* () {
	...
	it('renders swagger button if swaggerUrl is present and opens in new window', () =>
		__awaiter(void 0, void 0, void 0, function* () {
