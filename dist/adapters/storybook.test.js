...
describe('mswHandlersFromPlatform passthrough', () => {
	it('returns undefined (passthrough) when plugin is disabled, and mock when enabled', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			...
			const handler = handlers.find(h => {
				var _a;
				return ((_a = h.info) === null || _a === void 0 ? void 0 : _a.path) === '/api/foo';
			});
			...
			// @ts-ignore
			const passthrough = yield handler === null || handler === void 0
				? void 0
				: handler.resolver({ request: req, params: {}, cookies: {} });
			expect(passthrough).toBeUndefined();
		}));
});
describe('mswHandlersFromPlatform passthrough (absolute URL)', () => {
	it('returns undefined (passthrough) when absolute URL plugin is disabled, and mock when enabled', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			const platform = (0, platform_1.createMockPlatform)({
				name: 'test',
				plugins: [
			...
			const handler = handlers.find(h => {
				var _a;
				return ((_a = h.info) === null || _a === void 0 ? void 0 : _a.path) === 'https://jsonplaceholder.typicode.com/users/1';
			});
			expect(handler).toBeDefined();
			// Simulate a request
